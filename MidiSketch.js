...
//console.log(i+ " y "+ hexstring+ "Y" + SketchObject.tracks_array[i]);
    ...
    if(command==="to_file"){
      if(!SketchObject instanceof String){
        //if sketchobject is not string
        console.log("command to_file, works only with string type objects");
      }
      else{
        var textToWrite= SketchObject;
